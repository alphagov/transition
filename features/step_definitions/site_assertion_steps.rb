...
Then(/^I should be able to edit the site's mappings$/) do
  within '.mappings' do
    ...
    expect(page).to have_link('a', href: new_multiple_site_bulk_add_batches_path(@site))
  end
end
...
Then(/^I should not be able to edit the site's mappings$/) do
  within '.mappings' do
    ...
    expect(page).not_to have_link('a', href: new_multiple_site_bulk_add_batches_path(@site))
  end
end
